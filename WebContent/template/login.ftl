...
background: rgb(56,127,201); /* Old browsers */
...
/*rgb(56,127,201)background: -webkit-radial-gradient(center, ellipse cover,  rgba(185,210,224,1) 0%,rgba(187,214,228,1) 0%,rgba(186,211,225,1) 15%,rgba(186,211,225,1) 38%,rgba(169,199,215,1) 68%,rgba(169,199,215,1) 68%,rgba(169,199,215,1) 82%,rgba(158,191,208,1) 100%);  Chrome10-25,Safari5.1-6 */
...
<body>
    <div class="container">
    <div class="welcome text-center"> <center>Welcome to Assest Management System<center></center></center></div>
